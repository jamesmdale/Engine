...
//  =========================================================================================
AABB2 SpriteSheet::GetTexCoordsForSpriteCoords(const IntVector2& spriteCoords, bool doesFlip) const
{
	...
	if(doesFlip)
		...
		return AABB2(minx, miny, maxx, maxy); // have to flip coordinates because our image is upside down
}

//  =========================================================================================
AABB2 SpriteSheet::GetTexCoordsForSpriteIndex(const int& spriteIndex, bool doesFlip) const
{
	...
	return GetTexCoordsForSpriteCoords(spriteCoords, doesFlip);
}
