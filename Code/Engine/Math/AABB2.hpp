...
public:
	...
	void SetDimensions(float radiusX, float radiusY);
	...
	Vector2 GetBottomLeftPosition() const;
	Vector2 GetTopRightPosition() const;
	Vector2 GetBottomRightPosition() const;
